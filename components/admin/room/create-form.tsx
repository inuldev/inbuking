    ...
    <form action={formAction}>
      <div className="grid md:grid-cols-12 gap-5">
        ...
        <div className="col-span-4 bg-white p-4">
          <label
            htmlFor="input-file"
            className="flex flex-col mb-4 items-center justify-center aspect-video border-2 border-gray-300 border-dashed rounded-md bg-gray-50 relative cursor-pointer"
          >
            <div className="flex flex-col items-center justify-center text-gray-500 pt-5 pb-6 z-10">
              {pending ? (
                <BarLoader color="#ff9900" width={150} height={4} />
              ) : null}
              {image ? (
                <button
                  type="button"
